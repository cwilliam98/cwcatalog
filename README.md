...
:computer: A aplicação está sendo executada na porta 9999, está rodando no perfil de 'test' com o banco de dados H2 e contém um seeding de alguns produtos que são inseridos ao iniciar a aplicação.
